...
const demandasRoute = getRouteApi("/_app/demandas");

export const Route = createLazyFileRoute("/_app/demandas")({
...
function DemandasPage() {
  ...
  const urlSearch = demandasRoute.useSearch();
      ...
      <div className="space-y-6">
        ...
        {!demands?.length ? (
          <EmptyState
            ...
            linkLabel="Divulgar landing"
            linkTo="/configuracoes"
            linkSearch={{ tab: "landing" }}
          />
        ) : filtered.length === 0 ? (
          <EmptyState
            icon={AlertCircle}
