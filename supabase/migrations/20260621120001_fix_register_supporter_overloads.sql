-- Hotfix: PostgREST 404 — múltiplas overloads de register_supporter_from_landing.
-- Mantém uma única assinatura canônica (cep + email + liderança primária).

DROP FUNCTION IF EXISTS public.register_supporter_from_landing(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, UUID[]);
DROP FUNCTION IF EXISTS public.register_supporter_from_landing(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, UUID[], TEXT, TEXT);
DROP FUNCTION IF EXISTS public.register_supporter_from_landing(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, UUID[], TEXT, TEXT, UUID);
